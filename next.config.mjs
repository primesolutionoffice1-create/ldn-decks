...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/blog/deck-builder-aldie-va', destination: '/deck-builder-aldie-va', statusCode: 301 },
      { source: '/blog/deck-builder-broadlands-va', destination: '/deck-builder-broadlands-va', statusCode: 301 },
      { source: '/blog/deck-builder-cascades-va', destination: '/deck-builder-cascades-va', statusCode: 301 },
      ...
      { source: '/near-you/cascades-va', destination: '/deck-builder-cascades-va', permanent: true },
      { source: '/near-you/cascades', destination: '/deck-builder-cascades-va', permanent: true },
      ...
      { source: '/near-you/aldie-va', destination: '/deck-builder-aldie-va', permanent: true },
      { source: '/near-you/aldie', destination: '/deck-builder-aldie-va', permanent: true },
      ...
      { source: '/near-you/loudoun-county/aldie', destination: '/deck-builder-aldie-va', permanent: true },
      { source: '/near-you/loudoun-county/broadlands', destination: '/deck-builder-broadlands-va', permanent: true },
      { source: '/near-you/loudoun-county/cascades', destination: '/deck-builder-cascades-va', permanent: true },
      ...
      { source: '/top-decks-build-near-you/deck-builder-in-aldie', destination: '/deck-builder-aldie-va', permanent: true },
      ...
      { source: '/top-decks-build-near-you/deck-builder-in-cascades', destination: '/deck-builder-cascades-va', permanent: true },
      ...
      // /service/{city} hub pages → /deck-builder-{city}-va money pages (cannibalization fix)
      // Applies only to cities that have a dedicated static deck-builder page.
      { source: '/service/ashburn', destination: '/deck-builder-ashburn-va', permanent: true },
      { source: '/service/leesburg', destination: '/deck-builder-leesburg-va', permanent: true },
      { source: '/service/sterling', destination: '/deck-builder-sterling-va', permanent: true },
      { source: '/service/herndon', destination: '/deck-builder-herndon-va', permanent: true },
      { source: '/service/reston', destination: '/deck-builder-reston-va', permanent: true },
      { source: '/service/fairfax', destination: '/deck-builder-fairfax-va', permanent: true },
      { source: '/service/vienna', destination: '/deck-builder-vienna-va', permanent: true },
      { source: '/service/mclean', destination: '/deck-builder-mclean-va', permanent: true },
      { source: '/service/centreville', destination: '/deck-builder-centreville-va', permanent: true },
      { source: '/service/chantilly', destination: '/deck-builder-chantilly-va', permanent: true },
      { source: '/service/burke', destination: '/deck-builder-burke-va', permanent: true },
      { source: '/service/springfield', destination: '/deck-builder-springfield-va', permanent: true },
      { source: '/service/falls-church', destination: '/deck-builder-falls-church-va', permanent: true },
      { source: '/service/oakton', destination: '/deck-builder-oakton-va', permanent: true },
      { source: '/service/great-falls', destination: '/deck-builder-great-falls-va', permanent: true },
      { source: '/service/lorton', destination: '/deck-builder-lorton-va', permanent: true },
      { source: '/service/tysons', destination: '/deck-builder-tysons-va', permanent: true },
      { source: '/service/alexandria', destination: '/deck-builder-alexandria-va', permanent: true },
      { source: '/service/arlington', destination: '/deck-builder-arlington-va', permanent: true },
      { source: '/service/manassas', destination: '/deck-builder-manassas-va', permanent: true },
      { source: '/service/woodbridge', destination: '/deck-builder-woodbridge-va', permanent: true },
      { source: '/service/haymarket', destination: '/deck-builder-haymarket-va', permanent: true },
      { source: '/service/gainesville', destination: '/deck-builder-gainesville-va', permanent: true },
      { source: '/service/bristow', destination: '/deck-builder-bristow-va', permanent: true },
      { source: '/service/brambleton', destination: '/deck-builder-brambleton-va', permanent: true },
  ...
  async headers() {
    ...
    const csp = [
      ...
      "connect-src 'self' https://www.google-analytics.com https://*.google-analytics.com https://analytics.ahrefs.com https://*.vercel-insights.com https://vitals.vercel-insights.com https://www.googletagmanager.com https://pagead2.googlesyndication.com https://www.googleadservices.com https://googleads.g.doubleclick.net https://stats.g.doubleclick.net https://td.doubleclick.net https://ct.pinterest.com https://*.pinterest.com https://www.facebook.com https://*.facebook.com https://*.clarity.ms https://c.bing.com",
      "frame-src 'self' https://www.google.com https://td.doubleclick.net https://www.youtube.com https://www.youtube-nocookie.com https://ct.pinterest.com",
      "object-src 'none'",
      "base-uri 'self'",
      "form-action 'self'",
