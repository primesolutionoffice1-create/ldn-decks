...
Imported spend totals **0.0** with **0.0** conversions.

Blended imported CPA: **0**.
...
Do not scale budgets until tracking quality and learning phase status are known.
