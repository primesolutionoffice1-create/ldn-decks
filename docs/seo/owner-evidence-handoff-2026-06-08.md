# Owner Evidence Handoff — 2026-06-08
...
- Master action packet: `docs/seo/owner-evidence-action-packet-2026-06-08.csv` — 26 rows
- Sprint checklist report: `docs/seo/owner-evidence-sprint-2026-06-08.md` — 5 execution blocks
- Sprint checklist CSV: `docs/seo/owner-evidence-sprint-2026-06-08.csv` — 5 rows
- Project evidence intake: `docs/seo/project-evidence-intake-2026-06-08.csv` — 10 rows
- Photo ingestion manifest: `docs/seo/photo-ingestion-manifest-2026-06-08.csv` — 17 rows
- Warranty intake: `docs/seo/warranty-terms-intake-2026-06-08.csv` — 1 row(s)
- Repair cost intake: `docs/seo/repair-cost-ranges-intake-2026-06-08.csv` — 4 rows
- Directory citation status: `docs/seo/directory-citation-status-2026-06-08.md` — NADRA, Bing Places, Apple Business Connect, Nextdoor, and Angi
- NADRA directory packet: `docs/seo/nadra-directory-verification-packet-2026-06-08.md` — member profile and website badge proof
- Bing Places packet: `docs/seo/bing-places-verification-packet-2026-06-08.md` — public map and dashboard proof
- Apple Business Connect packet: `docs/seo/apple-business-connect-verification-packet-2026-06-08.md` — dashboard/public place proof
- Nextdoor cleanup packet: `docs/seo/nextdoor-citation-cleanup-packet-2026-06-08.md` — public cleanup proof
- Angi cleanup packet: `docs/seo/angi-citation-cleanup-packet-2026-06-08.md` — public cleanup proof
...
|---|---|---|---|
| NADRA directory | Live profile or member-dashboard screenshot showing Loudoun Decks membership and confirmation that the website badge links to the supplied profile URL. | `docs/seo/nadra-directory-verification-packet-2026-06-08.md` | Allowed in `sameAs`; still archive screenshot proof before marking resolved. |
| Bing Places | Current public Bing Maps screenshot plus Bing Places dashboard claim/sync, NAP, category, website, and email screenshots. | `docs/seo/bing-places-verification-packet-2026-06-08.md` | Do not promote as fresh public proof until current screenshots confirm canonical NAP. |
| Apple Business Connect | Dashboard claim/verification screenshot, NAP screen, category/service screen, website field, and public Apple Maps URL if available. | `docs/seo/apple-business-connect-verification-packet-2026-06-08.md` | Do not add Apple Maps to `sameAs` until dashboard or public place card confirms canonical NAP. |
| Nextdoor | Before/after public screenshots showing corrected Loudoun Decks name, canonical website/contact, clean categories, and claim/admin state if accessible. | `docs/seo/nextdoor-citation-cleanup-packet-2026-06-08.md` | Do not add Nextdoor to `sameAs` until public cleanup is visible. |
| Angi | Public/admin before-after screenshots, corrected profile URL, claim status, canonical NAP/website, category screenshot, and duplicate/name cleanup proof. | `docs/seo/angi-citation-cleanup-packet-2026-06-08.md` | Do not add Angi to `sameAs` until corrected public identity is verified. |
...
npm run seo:import-evidence -- --type projects --file docs/seo/project-evidence-intake-2026-06-08.csv --dry-run
npm run seo:ingest-assets -- --file docs/seo/photo-ingestion-manifest-2026-06-08.csv --preflight
npm run seo:ingest-assets -- --file docs/seo/photo-ingestion-manifest-2026-06-08.csv --dry-run
npm run seo:import-evidence -- --type warranty_terms --file docs/seo/warranty-terms-intake-2026-06-08.csv --dry-run
npm run seo:import-evidence -- --type repair_cost_ranges --file docs/seo/repair-cost-ranges-intake-2026-06-08.csv --dry-run
```
...
```bash
npm run seo:import-evidence -- --type projects --file docs/seo/project-evidence-intake-2026-06-08.csv --allow-verified
npm run seo:ingest-assets -- --file docs/seo/photo-ingestion-manifest-2026-06-08.csv --allow-verified
npm run seo:import-evidence -- --type warranty_terms --file docs/seo/warranty-terms-intake-2026-06-08.csv --allow-verified
npm run seo:import-evidence -- --type repair_cost_ranges --file docs/seo/repair-cost-ranges-intake-2026-06-08.csv --allow-verified
