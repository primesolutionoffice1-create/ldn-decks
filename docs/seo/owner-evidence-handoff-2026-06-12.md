# Owner Evidence Handoff — 2026-06-12
...
- Master action packet: `docs/seo/owner-evidence-action-packet-2026-06-12.csv` — 26 rows
- Sprint checklist report: `docs/seo/owner-evidence-sprint-2026-06-12.md` — 5 execution blocks
- Sprint checklist CSV: `docs/seo/owner-evidence-sprint-2026-06-12.csv` — 5 rows
- Project evidence intake: `docs/seo/project-evidence-intake-2026-06-12.csv` — 10 rows
- Photo ingestion manifest: `docs/seo/photo-ingestion-manifest-2026-06-12.csv` — 17 rows
- Warranty intake: `docs/seo/warranty-terms-intake-2026-06-12.csv` — 1 row(s)
- Repair cost intake: `docs/seo/repair-cost-ranges-intake-2026-06-12.csv` — 4 rows
- Directory citation status: `docs/seo/directory-citation-status-2026-06-12.md` — NADRA, Bing Places, Apple Business Connect, Nextdoor, and Angi
- NADRA directory packet: `docs/seo/nadra-directory-verification-packet-2026-06-12.md` — member profile and website badge proof
- Bing Places packet: `docs/seo/bing-places-verification-packet-2026-06-12.md` — public map and dashboard proof
- Apple Business Connect packet: `docs/seo/apple-business-connect-verification-packet-2026-06-12.md` — dashboard/public place proof
- Nextdoor cleanup packet: `docs/seo/nextdoor-citation-cleanup-packet-2026-06-12.md` — public cleanup proof
- Angi cleanup packet: `docs/seo/angi-citation-cleanup-packet-2026-06-12.md` — public cleanup proof
...
npm run seo:import-evidence -- --type projects --file docs/seo/project-evidence-intake-2026-06-12.csv --dry-run
npm run seo:ingest-assets -- --file docs/seo/photo-ingestion-manifest-2026-06-12.csv --preflight
npm run seo:ingest-assets -- --file docs/seo/photo-ingestion-manifest-2026-06-12.csv --dry-run
...
```bash
npm run seo:import-evidence -- --type projects --file docs/seo/project-evidence-intake-2026-06-12.csv --allow-verified
npm run seo:ingest-assets -- --file docs/seo/photo-ingestion-manifest-2026-06-12.csv --allow-verified
