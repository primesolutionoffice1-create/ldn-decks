# LDN Decks Deep SEO Growth Map — 2026-06-19
...
- App page modules scanned: 212
- Live sitemap URLs from latest weekly/live check: 732
- Internal links audited: 786 · bad links: 0
- JSON-LD files scanned: 146 · duplicate FAQ risks: 0 · NAP drift: 0
- Freshness audit: 186 fresh · 0 stale · 0 undated
- OG audit: unknown pages · 0 issues
- Breadcrumb audit: 0 unknown segments · 0 duplicate BreadcrumbList risks
...
- Owner action packet: 27 actions · 13 P0 · 14 P1.
...
- `/deck-cost-12x20-northern-virginia`
- `/deck-cost-16x20-northern-virginia`
- `/deck-cost-20x20-northern-virginia`
...
- `/outdoor-living-trends-northern-virginia-2026`
- `/outdoor-living/[city]`
- `/patios/[city]`
