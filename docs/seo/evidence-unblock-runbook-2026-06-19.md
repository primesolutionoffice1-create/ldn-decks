# Evidence Unblock Runbook - 2026-06-19
...
- Missing/partial photo or asset items: 12
...
| sitewide | blocked | 1 | 0 | 0 | 0 |
| /showcase | proof-incomplete | 0 | 6 | 0 | 0 |

## Intake Files

- Asset/photos: `docs/seo/photo-ingestion-manifest-2026-06-19.csv`
- Warranty terms: `docs/seo/warranty-terms-intake-2026-06-19.csv`
- Repair cost ranges: `docs/seo/repair-cost-ranges-intake-2026-06-19.csv`
- Project records: `docs/seo/project-evidence-intake-2026-06-19.csv`
- Before/after resolution: `docs/seo/before-after-evidence-resolution-2026-06-19.csv`
...
| Status | Asset ID | Needed | Owner Notes |
|---|---|---|---|
| red | `nadra-proud-member-logo` | Original or NADRA-approved Proud Member logo asset for the public trust badge. | Archive the original/NADRA-approved file before setting BUSINESS.memberships.logoPath. Do not recreate, redraw, screenshot-crop, or manually design the NADRA logo. |
