# Owner Evidence Handoff — 2026-06-02
...
- Master action packet: `docs/seo/owner-evidence-action-packet-2026-06-02.csv` — 26 rows
- Sprint checklist report: `docs/seo/owner-evidence-sprint-2026-06-02.md` — 5 execution blocks
- Sprint checklist CSV: `docs/seo/owner-evidence-sprint-2026-06-02.csv` — 5 rows
- Project evidence intake: `docs/seo/project-evidence-intake-2026-06-02.csv` — 10 rows
- Photo ingestion manifest: `docs/seo/photo-ingestion-manifest-2026-06-02.csv` — 17 rows
- Warranty intake: `docs/seo/warranty-terms-intake-2026-06-02.csv` — 1 row(s)
- Repair cost intake: `docs/seo/repair-cost-ranges-intake-2026-06-02.csv` — 4 rows
...
npm run seo:ingest-assets -- --file docs/seo/photo-ingestion-manifest-2026-06-02.csv --dry-run
...
npm run seo:ingest-assets -- --file docs/seo/photo-ingestion-manifest-2026-06-02.csv --allow-verified
