# Scaling Blocker Exit Checklist - 2026-06-19
...
- Exit command: `npm run seo:evidence-action-packet && npm run seo:evidence-action-packet:validate && npm run seo:validate-owner-intake && npm run seo:proof-preflight && npm run seo:weekly`
