# Owner Evidence Action Packet — 2026-06-19
...
- Asset requirements: 12 total · 12 unresolved
...
|---|---|---|---|
| NADRA directory | Live profile or member-dashboard screenshot showing Loudoun Decks membership, badge-link confirmation, and original/NADRA-approved logo asset before visual-logo rollout. | `docs/seo/nadra-directory-verification-packet-2026-06-19.md` | Allowed in `sameAs`; screenshot proof and official logo asset still required before resolved status. Do not replace the text badge with a recreated NADRA logo. |
| Bing Places | Public Bing Maps screenshot plus dashboard claim/sync, NAP, category, website, and email screenshots. | `docs/seo/bing-places-verification-packet-2026-06-19.md` | Do not promote as fresh proof without current screenshots. |
| Apple Business Connect | Dashboard claim/verification, NAP, category/service, website field, and public Apple Maps URL if available. | `docs/seo/apple-business-connect-verification-packet-2026-06-19.md` | Do not add Apple Maps to `sameAs` until canonical NAP is verified. |
| Nextdoor | Before/after public screenshots proving corrected name, website/contact, category cleanup, and claim/admin state if accessible. | `docs/seo/nextdoor-citation-cleanup-packet-2026-06-19.md` | Do not add Nextdoor to `sameAs` until cleanup is public. |
...
6. Dry-run imports with the correct evidence type before promotion:
   - Projects: `npm run seo:import-evidence -- --type projects --file docs/seo/project-evidence-intake-2026-06-19.csv --dry-run`
   - Warranty terms: `npm run seo:import-evidence -- --type warranty_terms --file docs/seo/warranty-terms-intake-2026-06-19.csv --dry-run`
   - Repair cost ranges: `npm run seo:import-evidence -- --type repair_cost_ranges --file docs/seo/repair-cost-ranges-intake-2026-06-19.csv --dry-run`
   - Photos/assets: `npm run seo:ingest-assets -- --file docs/seo/photo-ingestion-manifest-2026-06-19.csv --dry-run`
7. Regenerate and validate owner proof documents before promotion:
...
8. Promote verified rows only with `--allow-verified` after source review.
9. Run `npm run seo:validate-evidence`, `npm run seo:audit-placeholders`, and `npm run build` before public proof use.
