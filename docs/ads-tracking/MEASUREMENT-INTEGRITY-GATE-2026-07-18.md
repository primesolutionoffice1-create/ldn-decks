# Measurement Integrity Gate - 2026-07-18
...
- [PASS] Forms do not navigate to /thank-you without server proof
  - Evidence: useLeadSubmit fails conversion tracking closed when confirmationToken is missing.
  - Risk: A plain /thank-you fallback can trigger path-based conversion tags without a real server-confirmed lead.
