    ...
    adGroups: [
      {
        ...
        rsas: [
          {
            headlines: ['Deck Builders Near You', 'Custom Deck Builder', 'Call LDN Decks Today', 'Projects From $15k+', 'Permits & HOA Handled', '5.0 Rated Deck Builder', 'Loudoun Deck Builder', 'Fairfax Deck Builder', 'Trex Platinum Partner', 'Free Deck Estimate'],
            descriptions: ['Hire a local deck builder for serious custom projects in Northern Virginia.', 'Projects from $15k+. We handle design, permits, HOA, framing, decking, and rails.', 'Serving Loudoun, Fairfax, and Prince William County homeowners with premium decks.', 'Call LDN Decks for a clear estimate, timeline, and material recommendation.'],
          },
          {
            headlines: ['Build A Custom Deck', 'Northern VA Deck Pros', 'Licensed Deck Builder', 'Call For Deck Quote', 'Decks Built Right', 'Composite Deck Options', 'HOA Help Included', 'Free Consultation', 'Premium Deck Contractor', 'Schedule A Call'],
      ...
      },
      {
        ...
        rsas: [
          {
            headlines: ['Deck Contractors Near You', 'Deck Installation Pros', 'Call LDN Decks Today', 'Projects From $15k+', 'Permits & HOA Handled', 'Licensed & Insured', '5.0 Rated Contractor', 'Northern VA Decks', 'Composite Deck Experts', 'Free Deck Estimate'],
          ...
          {
            headlines: ['Custom Deck Contractor', 'Deck Construction Pros', 'Call For Estimate', 'Decks From $15k+', 'Trex & TimberTech', 'Built For NoVA Homes', 'HOA Approval Help', 'Premium Deck Builder', 'Schedule Consultation', 'Free Deck Quote'],
