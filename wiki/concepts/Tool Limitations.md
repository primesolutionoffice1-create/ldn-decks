...
Every recommendation in this brain is advisory until verified against live data and Ldndecks's confirmation. Below are the known limitations of the tools the audit will rely on.

## claude-seo

- Skill installs into Claude Code. Quality of the audit depends on Ldndecks configuring API access.
...
- Built before any audit data exists for https://ldndecks.com.
