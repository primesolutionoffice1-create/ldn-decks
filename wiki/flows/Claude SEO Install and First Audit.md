...
1. Subscribe to Claude (Pro or Max — Pro is sufficient to start).
2. Install Claude on your machine (desktop app or Claude Code CLI).
3. In Claude, run the install prompt:
...
1. In Claude, run `/seo-audit` with the site URL `https://ldndecks.com`.
