...
owner: "Brief author (Ldndecks)"
verifier: "Daniel Agrici (before publish)"
acceptance_criteria:
...
Owner: brief author (Ldndecks for in-sprint pages). Verifier: Daniel Agrici before publish — gate evidence is reviewed alongside the draft.
