...
Avoid: anything Ldndecks (or the named expert) hasn't personally practiced or verified. The information gain bar requires evidence the team can produce.
...
Owner: Ldndecks (sprint owner, drafting and publishing). On-the-ground evidence: the named expert (photos, logs, tested artifacts). Verifier: Daniel Agrici (gate compliance, information gain audit, schema and link hygiene).
