...
| ---------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- |
| GSC                    | Verified domain property for `https://ldndecks.com` (all variants — apex, www, http, https)                                                                                                                                | Missing |
...
| Asset library          | Source-resolution photo / screenshot / case-study library Ldndecks controls (for refresh and new hero work)                                                                                                                | Missing |
