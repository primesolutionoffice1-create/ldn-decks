...
- If the page needs a new visual direction or generated imagery, run [[Visual Reference Capture Workflow]] first so the style source, screenshots, and reuse boundaries are documented.
...
Owner: Ldndecks. Verifier: Daniel Agrici.
