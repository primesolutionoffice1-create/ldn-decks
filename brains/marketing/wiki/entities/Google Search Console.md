...
Primary measurement source for ldndecks.com. Without GSC access, every recommendation in this brain is advisory only. Status: access pending from [[Ldndecks]].

## Required Properties

- Domain property for `https://ldndecks.com` (preferred — covers all variants).
