  ...
  try {
    ...
    const payload = {
      ...
      custom_fields: {
        ...
        ad_consent: formData.get('ad_consent') === 'granted' ? 'granted' : 'denied',
        ad_consent_version: formData.get('ad_consent_version') || '',
        ad_consent_recorded_at: formData.get('ad_consent_recorded_at') || '',
        ...attribution,
      },
