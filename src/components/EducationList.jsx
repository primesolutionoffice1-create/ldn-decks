              ...
              <div className={styles.cardContent}>
                 ...
                 <div className={styles.cardFooter}>
                   ...
                   <div className={styles.shareBlock}>
                     ...
                     <button onClick={() => handleShare('Facebook', article.title)} className={styles.shareBtn} aria-label="Share on Facebook">
                       <FbIcon />
                     </button>
                     <button onClick={() => handleShare('Twitter', article.title)} className={styles.shareBtn} aria-label="Share on Twitter">
                       <TwIcon />
                     </button>
                     <button onClick={() => handleShare('LinkedIn', article.title)} className={styles.shareBtn} aria-label="Share on LinkedIn">
                       <LiIcon />
                     </button>
                   </div>
                 </div>
