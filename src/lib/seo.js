...
const OG_DEFAULTS = [
    ...
    [/^\/composite-deck-cost|^\/composite-deck-vs|^\/composite-decks/, "/images/img13.jpeg"],
...
const OG_IMAGE_DIMENSIONS = {
    ...
    "/images/screened-porch-cost-northern-virginia-2026.jpg": { width: 1810, height: 869 },
    "/images/homepage-intro-timbertech-deck.jpg": { width: 1536, height: 1024 },
