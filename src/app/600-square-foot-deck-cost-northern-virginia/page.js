    ...
    <>
      ...
      <article style={{ padding: '4rem 0', background: '#fff' }}>
        <div style={{ maxWidth: 900, margin: '0 auto', padding: '0 1.5rem' }}>
          ...
          <p style={S.p}>600 sqft triggers permit-ready + 3-inspection requirements in every NoVA county. Permit fees scale with construction valuation — typically $250–$800 at this size. Multi-level designs require additional structural drawings (load-path analysis for the elevated level), which we coordinate during structural planning.</p>
          <ul style={S.list}>
