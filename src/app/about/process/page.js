...
export default function ProcessPage() {
  return (
    <main>
      <WebPageSchema url="https://ldndecks.com/about/process" name="Our Deck Building Process | 6 Steps to Your Dream Deck" description="From free consultation to final walkthrough — our 6-step deck building process in Northern Virginia. Design, permits, HOA, construction, and warranty." speakable />
      <ProcessHeader />
      <ProcessSteps />
      <ServicesFooterInfo />
