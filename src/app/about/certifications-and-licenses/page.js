        ...
        <div style={{ maxWidth: 900, margin: '0 auto', padding: '0 1.5rem' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.5rem', marginBottom: '3rem' }}>
            {[
              ...
              { title: '5.0★ Google Rating', detail: `${BUSINESS.reviewSummary.reviewCount}+ Google reviews from Northern Virginia homeowners across Loudoun, Fairfax, and Prince William counties.`, verify: 'Search "Loudoun Decks" on Google Maps', badge: '5.0 ★★★★★' },
