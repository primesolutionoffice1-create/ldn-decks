...
export default function MegaGuidePage() {
  const sections = [
    ...
    { id: 'financing', title: '15. Financing Options', content: 'Financing options may be available for qualifying deck projects, including new builds, resurfacing, repairs, and composite upgrades. Approval is not guaranteed, terms may vary, and current options should be reviewed during your estimate.', link: '/deck-financing', linkText: 'Deck financing options →' },
  ];
