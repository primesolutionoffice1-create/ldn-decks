...
const questions = [
  {
    category: 'Budget & Planning', items: [
      ...
      { q: 'Should I finance or pay cash?', a: 'Financing options may be available for qualifying deck projects. Ask about current options during your estimate; approval is subject to provider review and terms may vary.', link: '/deck-financing' },
