...
export const metadata = buildMetadata({
  ...
  image: '/social/belmont-country-club-hoa-deck-rules-social.png',
});

const PATH = '/belmont-country-club-hoa-deck-rules';
...
const faqSchema = {
  ...
  mainEntity: [
    { "@type": "Question", name: "Do I need HOA approval for a deck in Belmont Country Club?", acceptedAnswer: { "@type": "Answer", text: "Yes. Decks, screened porches, pergolas, outdoor kitchens, fire features, and other exterior structures generally require approval through the Belmont Country Club Architectural Review Committee before construction begins. Belmont's premium community standards can require material samples, color specifications, structural drawings, and committee review." } },
    ...
    { "@type": "Question", name: "What does Belmont's ARC require in the submission packet?", acceptedAnswer: { "@type": "Answer", text: "Belmont submissions commonly need material samples or manufacturer specifications, color specifications with product codes, architectural drawings showing elevations and plan view, a site plan with setbacks, landscape impact notes, engineered structural drawings for complex builds, and homeowner authorization for contractor support." } },
    ...
    { "@type": "Question", name: "Can Loudoun Decks handle the Belmont Country Club ARC paperwork?", acceptedAnswer: { "@type": "Answer", text: "Yes. We prepare the ARC packet with material samples or specifications, support committee presentation needs when required, coordinate engineered structural drawings, file the Loudoun County building permit in parallel, and manage inspection scheduling. Call 571-655-7207." } },
  ],
};
...
export default function BelmontCountryClubHoaDeckRulesPage() {
  return (
    <>
      ...
      <WebPageSchema dateModified="2026-06-04" url={`https://ldndecks.com${PATH}`} name="Belmont Country Club HOA Deck Rules &amp; Approval Guide" description="Building a deck in Belmont Country Club, Ashburn? Detailed ARC review, material samples, committee timing, Loudoun County permit coordination, and premier deck planning." speakable />
      <ArticleSchema
        title="Belmont Country Club HOA Deck Rules and Approval Guide"
        description="Belmont Country Club ARC review, premium deck material planning, Loudoun County permit coordination, structural engineering triggers, and local deck builder support."
        path={PATH}
      ...
      <article style={{ padding: '4rem 0' }}>
        <div style={{ maxWidth: 900, margin: '0 auto', padding: '0 1.5rem' }}>
          ...
          <p style={S.p}>Average review on a complete packet: <strong>21-35 days</strong> depending on the meeting cycle and project complexity. A complete submission packet reduces revision risk and gives the committee the structural, material, and lot-context information needed for review.</p>
          ...
          <p style={S.p}>For estate-tier projects, the support documents should also clarify ledger flashing, stair geometry, point loads, and inspection access. Review our <Link href="/education/ledger-board-flashing-deck-attachment-virginia" style={{ color: 'var(--color-primary)' }}>ledger board flashing guide</Link>, <Link href="/tools/deck-load-calculator-virginia" style={{ color: 'var(--color-primary)' }}>deck load calculator</Link>, and <Link href="/education/deck-stair-construction-diagram" style={{ color: 'var(--color-primary)' }}>deck stair construction diagram</Link> before finalizing the scope.</p>
          ...
          <p style={S.p}>We prepare the full packet with physical material samples, landscape impact details, structural drawings, committee-meeting support when needed, engineered structural coordination, Loudoun County permit filing, and inspection scheduling through the project lifecycle. See more on our <Link href="/deck-builder-ashburn-va" style={{ color: 'var(--color-primary)' }}>Ashburn deck builder page</Link>.</p>
      ...
      <SimpleCTA title="Belmont Country Club deck project? We file every premier approval." buttonText="Get Free Estimate" link="/get-estimate" />
      <NamedAuthor context="Belmont Country Club (Ashburn) — premier estate-tier deck construction" lastUpdated="2026-06-04" />
