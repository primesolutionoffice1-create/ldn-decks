      ...
      <article style={{ padding: '4rem 0' }}>
        <div style={{ maxWidth: 900, margin: '0 auto', padding: '0 1.5rem' }}>
          ...
          <ul style={{ paddingLeft: '1.5rem', marginBottom: '2rem' }}>
            ...
            <li style={{ marginBottom: '0.5rem', lineHeight: 1.7 }}><strong>Permit support.</strong> We help homeowners plan county permit requirements with Loudoun, Fairfax, Prince William, Arlington, and Stafford counties, with responsibilities, fees, and inspection coordination confirmed in the written project scope.</li>
