    ...
    <>
      ...
      <article style={{ padding: '5rem 0', background: '#fff' }}>
        <div style={{ maxWidth: 900, margin: '0 auto', padding: '0 1.5rem' }}>
          ...
          <p style={S.p}>Stairs are reviewed as part of the full structural system, especially on elevated decks. Our <Link href="/education/deck-stair-construction-diagram" style={{ color: 'var(--color-primary)', fontWeight: 600 }}>deck stair construction diagram</Link> shows how treads, risers, stringers, hangers, and landings fit together before the framing inspection, while the <Link href="/education/deck-stair-code-rise-run-virginia" style={{ color: 'var(--color-primary)', fontWeight: 600 }}>stair code guide</Link> covers rise, run, handrail, guard, and landing requirements. Homeowners preparing for final inspection can also use the <Link href="/education/deck-stair-safety-inspection-checklist" style={{ color: 'var(--color-primary)', fontWeight: 600 }}>deck stair safety checklist</Link> and review <Link href="/education/common-deck-stair-inspection-failures-virginia" style={{ color: 'var(--color-primary)', fontWeight: 600 }}>common stair inspection failures</Link> before corrections become expensive.</p>
