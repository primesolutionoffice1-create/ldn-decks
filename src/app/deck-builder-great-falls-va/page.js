...
export default function GreatFallsDeckBuilderPage() {
  return (
    <>
      ...
      <WebPageSchema dateModified="2026-06-01" url="https://ldndecks.com/deck-builder-great-falls-va" name="Best Deck Builder in Great Falls, VA | Premium Composite Decks" description="Trusted deck builder for Great Falls, VA. Premium Trex &amp; AZEK decks for $1M+ homes. Google reviews. RPA-zone expertise. Free estimate. Call (571) 655-7207." speakable />
      ...
      <NamedAuthor context="Great Falls and Northern Virginia" lastUpdated="2026-06-01" />
      <ContactHome />
    </>
  );
}
