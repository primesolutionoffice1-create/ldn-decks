          ...
          <ol style={{ paddingLeft: '1.5rem', marginBottom: '2rem' }}>
            ...
            <li style={{ marginBottom: '1rem', lineHeight: 1.7 }}><strong>Three inspections during construction:</strong>
              <ul style={{ paddingLeft: '1.25rem', marginTop: '0.5rem' }}>
                ...
                <li>Final inspection complete structure including railings, stairs, and fasteners. For stair terminology and layout, see our <Link href="/education/deck-stair-construction-diagram" style={{ color: 'var(--color-primary)', fontWeight: 600 }}>deck stair construction diagram</Link>.</li>
              </ul>
            </li>
          </ol>
