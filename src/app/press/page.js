      ...
      <article style={{ padding: '4rem 0' }}>
        <div style={{ maxWidth: 900, margin: '0 auto', padding: '0 1.5rem' }}>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.95rem' }}>
              <tbody>
                {[
                  ...
                  ['Google Rating', `5.0 stars (${BUSINESS.reviewSummary.reviewCount}+ verified reviews)`],
          ...
          <ul style={{ paddingLeft: '1.5rem', marginBottom: '2rem', lineHeight: 1.8 }}>
            ...
            <li><strong>5.0-star Google rating</strong> with {BUSINESS.reviewSummary.reviewCount}+ verified reviews</li>
