...
export default function BroadlandsHoaDeckRulesPage() {
  return (
    <>
      ...
      <WebPageSchema url="https://ldndecks.com/broadlands-hoa-deck-rules" name="Broadlands HOA Deck Rules &amp; Approval Guide" description="Building a deck in Broadlands, Ashburn? Learn how the Broadlands HOA architectural review works, how it pairs with the Loudoun County permit, and how to get approved." speakable />
