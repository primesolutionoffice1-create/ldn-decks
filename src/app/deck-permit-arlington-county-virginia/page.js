    ...
    <>
      ...
      <article style={{ padding: '5rem 0', background: '#fff' }}>
        <div style={{ maxWidth: 900, margin: '0 auto', padding: '0 1.5rem' }}>
          ...
          <ol style={S.list}>
            <li style={S.listItem}><strong>Footing inspection</strong> — performed after the footings are excavated but before concrete is poured. Inspector verifies depth, diameter, bearing soil, and reinforcement. The <Link href="/tools/deck-footing-depth-calculator-virginia" style={{ color: 'var(--color-primary)', fontWeight: 600 }}>footing depth calculator</Link> is a planning aid only; the Arlington inspector and approved drawings control the final requirement.</li>
