  ...
  return (
    <>
      ...
      <section style={{ background: 'var(--color-dark)', color: '#fff', padding: '3rem 0 2rem' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', padding: '0 1.5rem', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(280px, 100%), 1fr))', gap: '3rem', alignItems: 'center' }}>
          <div>
      ...
      <section id="estimate-form" style={{ padding: '3rem 0', background: '#fff', scrollMarginTop: '12rem' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', padding: '0 1.5rem', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(300px, 100%), 1fr))', gap: '3rem' }}>
