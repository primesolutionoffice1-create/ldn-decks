...
export const metadata = buildMetadata({
  path: '/trex-decks',
  title: 'Trex Deck Builder NoVA | Composite Deck Contractor',
  description: 'Looking for a Trex product-line planning in Northern Virginia? Loudoun Decks specializes in premium Trex Transcend & Lineage installations. Free written estimates!',
...
const inclusions = [
  {
    ...
    desc: "We specialize in the Transcend line, offering the strong scratch resistance and deep wood grain available in Northern Virginia."
  },
  {
...
const trexFAQs = [
  {
    q: "Why should I choose a Trex-focused deck builder in Loudoun County?",
    a: "A Trex-focused builder understands product-line requirements for joist spacing, ventilation, approved fasteners, railing integration, and warranty documentation. Homeowners should verify manufacturer profile status and warranty terms directly before choosing a builder."
  },
  {
  ...
  },
  {
    ...
    a: "Trex Transcend decking carries current 50-year limited residential fade and stain coverage from Trex. Real-world lifespan still depends on frame condition, ventilation, fasteners, cleaning, sun exposure, and correct installation details."
  },
  {
  ...
  },
  {
    ...
    a: "Yes. Trex is a highly recognized premium brand. Having a 'Trex Deck' is a major selling point for premium homes in Loudoun and Fairfax Counties."
  }
];
...
const expansionSections = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "By choosing a Trex installer, you are supporting sustainable construction practices while ensuring your home features the world's most trusted name in outdoor living. Learn more about our [eco-friendly decking approach](/eco-friendly-composite-decking)."
    ]
  },
  {
  ...
  return (
    <main>
      ...
      <GeoAnswerBlock
        ...
        answer="Loudoun Decks helps Northern Virginia homeowners plan Trex deck projects across Loudoun, Fairfax, Prince William, Arlington, Alexandria, and nearby service areas. This page is built for homeowners comparing Trex Enhance, Select, Transcend, Signature railing, lighting, drainage, permits, HOA review, and written estimate paths before choosing a low-maintenance composite deck."
        facts={[
      ...
      <section style={{ padding: '3rem 1.5rem', background: '#fff' }}>
        <div style={{ maxWidth: 900, margin: '0 auto' }}>
          ...
          <p data-speakable style={{ marginBottom: '1.5rem', lineHeight: 1.7, color: '#2d3748' }}>
            ...
            $22,000–$32,000; Trex Signature composite decking usually runs $28,000–$40,000+ for the same
            size.
          </p>
      ...
      <ServiceInclusions
        ...
        description="With Trex product-line planning, we bring the full Trex product ecosystem — decking, railings, lighting and drainage — to every Northern Virginia project."
        items={inclusions}
      />
      ...
      <section style={{ padding: '2rem 1.5rem', maxWidth: 900, margin: '0 auto' }}>
        ...
        <ul style={{ listStyle: 'none', padding: 0 }}>
          ...
          <li style={{ marginBottom: '0.5rem' }}><Link href="/deck-builder-northern-virginia" style={{ color: 'var(--color-primary)', fontWeight: 600 }}>Northern Virginia deck builder for Trex projects →</Link></li>
