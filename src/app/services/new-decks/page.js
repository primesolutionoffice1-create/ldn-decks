...
const expansionSections = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Framing follows IRC residential code with species-graded lumber sized to the actual span. A 16-foot joist span on a Trex Transcend surface calls for 2×10 joists at 12-inch spacing — not the 2×8 at 16-inch spacing that works for pressure-treated boards. We match joist size and spacing to the decking manufacturer's deflection tables, not to a generic framing rule. For more on this, read our guide to [deck joist sizing](/blog/2x8-vs-2x10-deck-joists), [Virginia footing depth requirements](/deck-footing-code-northern-virginia), the [Deck Footing Depth Calculator Virginia](/tools/deck-footing-depth-calculator-virginia), and the [Deck Beam Span Calculator Virginia](/tools/deck-beam-span-calculator-virginia).",
