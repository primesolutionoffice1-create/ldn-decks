...
const materialItemListSchema = {
  "@context": "https://schema.org",
  "@type": "ItemList",
  "@id": "https://ldndecks.com/services/patios#patio-materials",
  "name": "Northern Virginia patio material comparison",
  "itemListOrder": "https://schema.org/ItemListOrderAscending",
  "itemListElement": materialComparison.map((material, index) => ({
    "@type": "ListItem",
    "position": index + 1,
    "name": material.name,
    "description": `${material.cost}; ${material.durability}; ${material.freezeThaw}; best for ${material.bestFor}.`
  }))
};
      ...
      <section style={{ padding: '2.5rem 1.5rem 1rem' }}>
        <div style={S.container}>
          ...
          <ul style={{ paddingLeft: '1.25rem', marginBottom: '1.5rem' }}>
            ...
            <li style={{ marginBottom: '0.55rem', lineHeight: 1.7 }}><strong>Patio + screened porch</strong>: open patio space adjacent to a <Link href="/screened-porch-builder-northern-virginia" style={{ color: 'var(--color-primary)', fontWeight: 600 }}>screened porch</Link>, sharing the same footing line and finish floor elevation.</li>
